      ...
      <div class="bg-[#2b2938] p-8 rounded-lg shadow-md w-full max-w-md">
        <div class="text-center mb-8">
          <img
            ...
            alt="logo"
          />
          <h1 class="text-2xl font-bold text-[#f7c279] mt-2">
            Create an Account
          </h1>
        </div>
        ...
        <form (ngSubmit)="onSubmit()" #registerForm="ngForm">
          ...
          <div class="mb-6">
            <label for="confirmPassword" class="block text-[#dfddf3] mb-2"
        ...
        <div class="mt-4 text-center text-[#dfddf3]">
          ...
          <a routerLink="/login" class="text-[#f7c279] hover:underline"
            >Login</a
          >
        </div>
      </div>
